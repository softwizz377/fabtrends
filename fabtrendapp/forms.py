...
from fabtrendapp.models import contact, Product, feedback, query
...
class Productform(forms.ModelForm):
    name = forms.CharField(max_length=200)
    productbrand = forms.CharField(max_length=200)
    image = forms.ImageField()
    subcategory = forms.CharField()
    description = forms.CharField(widget=forms.Textarea)
    quantity = forms.IntegerField()
    price = forms.IntegerField()
    material = forms.CharField(max_length=500)
    quantity = forms.IntegerField()
    price = forms.IntegerField()
    discounted_price = forms.IntegerField()
    size = forms.CharField(max_length=500)
    image = forms.ImageField()
...
class FAQsform(forms.ModelForm):
    ...
    phoneno = forms.CharField(widget=forms.Textarea)
